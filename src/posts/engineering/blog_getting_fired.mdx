...
keywords: [ "Software Engineer", "Fired", "start up", "experience", "hindsight", "let go", "probation", "failed probation", "software developer", "learning experience"]
...
As such, I was mostly confident about my ability to work on the feedback, a lot of it was about managing my hyper-vigilance and my attention, which, as I had just started the process of getting a formal diagnosis for CPTSD at the time (or ADHD, the psychiatrist decided on CPTSD), I had the right feedback now to be able to find the right tools to act on it. 
